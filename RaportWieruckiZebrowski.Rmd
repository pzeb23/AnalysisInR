...
*W drzewie klasyfikacji możemy zaobserwować prawidłowość klasyfikowania klienta na podstawie łącznej liczby transakcji (Total_Trans_Ct). Następne w kolejności, zmiennymi najlepiej dyskryminującymi są "Łączna kwota transakcji" (Total_Trans_Amt) oraz "Łączna kwota transakcji" (Total_Trans_Amt). *
